...
IDim = gtx.Dimension("IDim", kind=gtx.DimensionKind.HORIZONTAL)
JDim = gtx.Dimension("JDim", kind=gtx.DimensionKind.HORIZONTAL)
Kolor = gtx.Dimension("Kolor", kind=gtx.DimensionKind.HORIZONTAL)
